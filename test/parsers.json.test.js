...
describe("JSON parser", function () {
    it('Test 1', function () {
        return getApp().scrape(JSON.parse(fs.readFileSync('./test/sources/json/json1.json', 'utf-8'))).then(articles => {
            ...
            expect(articles[1].thumbnail_url).to.equal('https://financeclub.unipi.gr/wp-content/uploads/2022/09/cfa-opengraph-share-image-300x300.png');
        });
    });
});
//# sourceMappingURL=parsers.json.test.js.map